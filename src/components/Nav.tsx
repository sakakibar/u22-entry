...
<ul className={styles.ul}>
  ...
  <li className={`${styles.li} ${pathname === "/mypage" ? styles.active : ""}`}>
    <Link href="/mypage" className={styles.linkContent}>
      {/* 設定（歯車）アイコン */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className={styles.icon}
      ...
      {isRegisterOpen && <RegisterModal onClose={closeRegister} onLogin={openLogin} />}
    </>
  );
};